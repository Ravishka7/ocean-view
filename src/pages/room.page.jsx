...
import { RoomBookingModal } from "@/components/RoomBooking";
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    className="w-80 py-2 px-4 text-white bg-blue-800 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-50 disabled:bg-blue-300 disabled:cursor-not-allowed transition duration-300"
                  >
                    Book Now
                  </Button>
                </div>
